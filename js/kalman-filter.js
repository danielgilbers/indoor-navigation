 ...
 */
      function getArgument () {
        const x = this.re
        const y = this.im
        const epsilon = 1 / (Math.pow(10, 15) * 2)
 ...
 */
      function isEqual (num1, num2) {
        ...
        const EPSILON = 1 / (Math.pow(10, digit) * 2)
 ...
 */
      ...
      function LU (A) {
        ...
        const EPSILON = 1 / (Math.pow(10, A._digit) * 2)
        ...
        const P = this.generate(row, row, function (i, j) {
        ...
        const L = this.generate(row, size, function (i, j) {
          if (i === j) {
            return 1
          }
        ...
        const U = this.generate(size, col, function (i, j) {
          if (i > j) {
            return 0
          }
 ...
 */
  ...
  \*****************************************************************************/
    /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      const _require = __webpack_require__(/*! ../../Error */ './node_modules/@rayyamhk/matrix/lib/Error.js')
      const INVALID_MATRIX = _require.INVALID_MATRIX
      const INVALID_UPPER_TRIANGULAR_MATRIX = _require.INVALID_UPPER_TRIANGULAR_MATRIX
      const INVALID_SQUARE_MATRIX = _require.INVALID_SQUARE_MATRIX
      const SIZE_INCOMPATIBLE = _require.SIZE_INCOMPATIBLE
      const NO_UNIQUE_SOLUTION = _require.NO_UNIQUE_SOLUTION
      /**
...
*/
      ...
      function backward (U, y) {
        ...
        const EPSILON = 1 / (Math.pow(10, U._digit) * 2)
  ...
  \****************************************************************************/
    /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      const _require = __webpack_require__(/*! ../../Error */ './node_modules/@rayyamhk/matrix/lib/Error.js')
      const INVALID_MATRIX = _require.INVALID_MATRIX
      const INVALID_LOWER_TRIANGULAR_MATRIX = _require.INVALID_LOWER_TRIANGULAR_MATRIX
      const INVALID_SQUARE_MATRIX = _require.INVALID_SQUARE_MATRIX
      const SIZE_INCOMPATIBLE = _require.SIZE_INCOMPATIBLE
      const NO_UNIQUE_SOLUTION = _require.NO_UNIQUE_SOLUTION
      /**
 ...
 */
      ...
      function forward (L, y) {
        ...
        const EPSILON = 1 / (Math.pow(10, L._digit) * 2)
 ...
 */
  ...
  \**********************************************************************/
    /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      const INVALID_MATRIX = _require.INVALID_MATRIX
      const INVALID_SQUARE_MATRIX = _require.INVALID_SQUARE_MATRIX
      const SINGULAR_MATRIX = _require.SINGULAR_MATRIX
 ...
 */
  ...
  \******************************************************************/
    /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      const INVALID_MATRIX = _require.INVALID_MATRIX
      const INVALID_SQUARE_MATRIX = _require.INVALID_SQUARE_MATRIX
      const INVALID_EXPONENT = _require.INVALID_EXPONENT
      /**
 ...
 */
      ...
      function eigenvalues () {
        ...
        for (let i = size - 1; i > 0; i--) {
          ...
          const shift = clone[size - 1][size - 1] // eslint-disable-next-line no-constant-condition
      ...
      function HouseholderTransform (A, digit) {
        ...
        for (let j = 0; j < size - 2; j++) {
          ...
          for (let _m3 = 0; _m3 < size; _m3++) {
            ...
            for (let _n2 = 0; _n2 < _v.length; _n2++) {
      ...
      function HessenbergQR (H, digit) {
        ...
        for (let i = 0; i < size - 1; i++) {
          const a = H[i][i]
          const c = H[i + 1][i]
          const norm = Math.sqrt(Math.pow(a, 2) + Math.pow(c, 2))
 ...
 */
      ...
      function norm () {
        ...
        if (p === 2) {
          ...
          for (let _i2 = 0; _i2 < eigenvalues.length; _i2++) {
            const value = eigenvalues[_i2].getModulus()
 ...
 */
      ...
      function rank () {
        ...
        const EPSILON = 1 / (Math.pow(10, this._digit) * 2)
 ...
 */
      ...
      function isEqual (A, B) {
        ...
        const EPISILON = 1 / (Math.pow(10, digit) * 2)
        const matrixA = A._matrix
        const matrixB = B._matrix
